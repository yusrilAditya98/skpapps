...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a><img src="<?= base_url('assets/img/skpapps.png') ?>" alt="" width="200dp" class="mt-2"></a>
        </div>
        ...
        <?php else : ?>
            <ul class="sidebar-menu">
                <li class="menu-header mt-2">Admin</li>
                <li class="nav-item">
                    <a href="<?= base_url('Admin') ?>" class="nav-link "><i class="fas fa-fire"></i><span>Dashboard</span></a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('Admin/ManagementUser') ?>" class="nav-link "><i class="fas fa-fire"></i><span>Manajament User</span></a>
                </li>
            </ul>
        <?php endif; ?>
    </aside>
