                                ...
                                <tbody>
                                    ...
                                    foreach ($kegiatan as $k) : ?>
                                        <tr>
                                                ...
                                                <?php for ($i = 0; $i < count($validasi); $i++) : ?>
                                                    ...
                                                    <?php elseif ($validasi[$i]['id_kegiatan'] == $k['id_kegiatan'] && $validasi[$i]['jenis_validasi'] == 6) : ?>
                                                        <?php if ($validasi[$i]['status_validasi'] == 0 || $validasi[$i]['status_validasi'] == 2 || $validasi[$i]['status_validasi'] == 4) : ?>
                                                            <a href="<?= base_url('Keuangan/validasiProposal/') . $k['id_kegiatan'] ?>?valid=1&&jenis_validasi=6" class="btn btn-icon btn-success confirm-validasi">valid</a>
                                            ...
                                            <td> <a target="_blank" href="<?= base_url('Keuangan/cetakPengajuanDana/') . $k['id_kegiatan'] ?>?status=proposal" class="btn btn-warning">cetak</a></td>
                                        </tr>
                                    <?php endforeach; ?>
