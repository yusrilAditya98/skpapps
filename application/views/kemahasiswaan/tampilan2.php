                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" border="px-2">
                                            <thead class="text-center">
                                                <tr>
                                                    <th scope="col" rowspan="2">No</th>
                                                    <th scope="col" rowspan="2">Tanggal Kegiatan</th>
                                                    <th scope="col" rowspan="2">Nama Kegiatan</th>
                                                    <th scope="col" rowspan="2">Keterangan</th>
                                                    <th scope="col" rowspan="2">Jumlah Termasuk Pajak</th>
                                                    <th scope="col" class="text-center" colspan="4">Pajak</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">PPN-DN</th>
